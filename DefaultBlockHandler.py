    ...
    def __init__(self, centre: vec3 = vec3()):
        self.vertices = [
            vec4(centre, 0) + relVec for relVec in [
                ...
                vec4(0.5, 0, 0.5, 8),  # 8
                vec4(0.5, 0, -0.5, 9),  # 9
                vec4(0.5, 1, -0.5, 10),  # 10
                vec4(0.5, 1, 0.5, 11),  # 11

                vec4(-0.5, 0, 0.5, 12),  # 12
                vec4(-0.5, 0, -0.5, 13),  # 13
                vec4(-0.5, 1, -0.5, 14),  # 14
                vec4(-0.5, 1, 0.5, 15),  # 15

                vec4(0.5, 0, 0.5, 16),  # 16
                vec4(-0.5, 0, 0.5, 17),  # 17
                vec4(-0.5, 1, 0.5, 18),  # 18
                vec4(0.5, 1, 0.5, 19),  # 19

                vec4(0.5, 0, -0.5, 20),  # 20
                vec4(-0.5, 0, -0.5, 21),  # 21
                vec4(-0.5, 1, -0.5, 22),  # 22
                vec4(0.5, 1, -0.5, 23),  # 23
            ]]
